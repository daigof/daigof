...
using PropelAuth.
- Improved core scanning infrastructure through system-level enhancements to a
...
- Selected engagements included Curology, PaidUp, iwoca, Sellr, CUPS, Listen360,
PVBid, and DoubleNet Pay.
...
platform to an Angular single-page application.
...
- Designed and supported global corporate web applications, including an
